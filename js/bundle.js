...
/* harmony export */ });
function calc() {
    // 96. Создаем калькулятор на сайте, часть 1. (97 часть 2.)
...
function forms(modalTimerId) {
    //Урок 83-84 Реализация скрипта отправки данных на сервер.(forms)

    const forms = document.querySelectorAll('form');
    const message = {
        loading: "img/form/spinner.svg",
        success: "Успешно",
        failed: "Ошибочка вышла"
    };
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (gson);
...
/* harmony export */ });
function slider() {
    // 91 Создаем слайдер на сайте,Вариант 1. 92 Вариант 2.
    ...
    next.addEventListener('click', () => {
        if (offset == +width.slice(0, width.length - 2) * (slides.length - 1)) { //500px  - width (нужно избавиться от букв,и превратить в число)
            offset = 0;
        } else {
...
/* harmony export */ });
function tabs() {
    // 63 Создаем табы в новом проекте.Переключение картинок без перезагрузки сайта.
...
/* harmony export */ });
function timer() {
    // 68 Создаем таймер обратного отчёта. Отчёт до определенного времени.
...
/* harmony import */ var _modules_gson__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/gson */ "./js/modules/gson.js");
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_gson__WEBPACK_IMPORTED_MODULE_4__["default"])();
